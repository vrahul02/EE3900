...
A system with input $x[n]$ and output $y[n]$ is given as $y[n]=\sin{\frac{5}{6}\pi n} \times x(n)$. The system is:\\
\begin{enumerate}
...
\begin{align}
    x(n)=&x_1(n)\\
    \implies y_1(n)=&\sin{\frac{5}{6}\pi n} \times x_1(n)\\
    x(n)=&x_2(n)\\
    \implies y_1(n)=&\sin{\frac{5}{6}\pi n} \times x_1(n)
\end{align}
If
\begin{align}
    x(n)=&x_1(n)+x_2(n)\\
    \implies y(n)=&\sin{\frac{5}{6}\pi n} \times x_1(n)+\sin{\frac{5}{6}\pi n} \times x_1(n)\\
    y(n)=&\sin{\frac{5}{6}\pi n} \times (x_1(n)+x_2(n))\\
