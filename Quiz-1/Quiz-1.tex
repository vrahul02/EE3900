...
\begin{figure}[!htb]
         \centering
         \includegraphics[width=0.9\columnwidth]{Quiz-1(1).png}
         \caption{Plot of $x_0[n]$}
         \label{plot}
\end{figure}
\begin{figure}[!htb]
         \centering
         \includegraphics[width=0.9\columnwidth]{Quiz-1(2).png}
...
\begin{figure}[!htb]
         \centering
         \includegraphics[width=0.9\columnwidth]{Quiz-1(3).png}
...
\begin{align}
    y[n]=y_0[n-2]+2y_o[n-4]+y_0[n-6]
\end{align}
and we get sequence $y_1[n]$ shown here as the output for $x_1[n]$ :
\begin{figure}[!htb]
         \centering
         \includegraphics[width=0.9\columnwidth]{Quiz-1(4).png}
